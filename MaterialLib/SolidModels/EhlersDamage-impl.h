 ...
 *
 */
#ifndef MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_IMPL_H_
#define MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_IMPL_H_
...
double yieldFunction(
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    typename SolidEhlersDamage<DisplacementDim>::MaterialProperties const& mp,
...
void calculatePlasticResidual(
    ...
    double const lambda,
    typename SolidEhlersDamage<DisplacementDim>::MaterialProperties const& _mp,
    typename SolidEhlersDamage<DisplacementDim>::ResidualVectorType& residual)
{
...
void calculatePlasticJacobian(
    ...
    double const t,
    ProcessLib::SpatialPosition const& x,
    typename SolidEhlersDamage<DisplacementDim>::JacobianMatrix& jacobian,
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    double const lambda,
    typename SolidEhlersDamage<DisplacementDim>::MaterialProperties const& _mp)
{
...
template <int DisplacementDim>
void SolidEhlersDamage<DisplacementDim>::MaterialProperties::
...
template <int DisplacementDim>
typename SolidEhlersDamage<DisplacementDim>::KelvinVector predict_sigma(
    double const G, double const K,
    typename SolidEhlersDamage<DisplacementDim>::KelvinVector const& sigma_prev,
    typename SolidEhlersDamage<DisplacementDim>::KelvinVector const& eps,
    typename SolidEhlersDamage<DisplacementDim>::KelvinVector const& eps_prev,
    double const eps_V)
{
    static int const KelvinVectorSize =
        ProcessLib::KelvinVectorDimensions<DisplacementDim>::value;
...
template <int DisplacementDim>
bool SolidEhlersDamage<DisplacementDim>::computeConstitutiveRelation(
    double const t,
    ProcessLib::SpatialPosition const& x,
    double const dt,
...
#endif  // MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_IMPL_H_
