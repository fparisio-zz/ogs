...
#ifndef MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_H_
#define MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_H_
...
public:
    explicit SolidEhlersDamage(MaterialProperties const& material_properties)
...
#endif  // MATERIALLIB_SOLIDMODELS_EHLERSDAMAGE_H_
