...
std::tuple<typename Lubby2<DisplacementDim>::KelvinVector,
           ...
           std::unique_ptr<typename Lubby2<DisplacementDim>::KelvinMatrix>>
        ...
        material_state_variables)
{
    ...
    {  // Local Newton solver
        ...
        if (!success_iterations)
            return std::make_tuple(sigma_prev, nullptr, nullptr);
    ...
    auto C = std::unique_ptr<KelvinMatrix>{new KelvinMatrix};
    *C = tangentStiffnessA<DisplacementDim>(local_lubby2_properties.GM0,
