...
template <int DisplacementDim>
double SolidEhlers<DisplacementDim>::getOvernonlocalGammaFactor(
...
template <int DisplacementDim>
double SolidEhlers<DisplacementDim>::calculateDamageKappaD(
...
template <int DisplacementDim>
double SolidEhlers<DisplacementDim>::calculateDamage(
    double const t, ProcessLib::SpatialPosition const& x_position,
