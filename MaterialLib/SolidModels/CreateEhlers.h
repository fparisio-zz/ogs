...
inline std::unique_ptr<DamageProperties> createDamageProperties(
    ...
    BaseLib::ConfigTree const& config)
{
    ...
    return std::unique_ptr<DamageProperties>{
        new DamageProperties{alpha_d, beta_d, h_d}};
}
    ...
    BaseLib::ConfigTree const& config)
{
    ...
    // Damage properties.
    std::unique_ptr<DamageProperties> ehlers_damage_properties;
