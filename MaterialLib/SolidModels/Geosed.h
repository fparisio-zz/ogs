...
class SolidGeosed final : public MechanicsBase<DisplacementDim>
{
public:
...
public:
    explicit SolidGeosed(
        MaterialProperties const& material_properties,
        std::unique_ptr<GeosedDamageProperties>&& damage_properties)
...
private:
    ...
    std::unique_ptr<GeosedDamageProperties> _damage_properties;
};

}  // namespace Geosed
}  // namespace Solids
}  // namespace MaterialLib
#include "Geosed-impl.h"
