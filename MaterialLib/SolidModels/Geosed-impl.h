...
template <int DisplacementDim>
typename SolidGeosed<DisplacementDim>::KelvinVector plasticFlowDeviatoricPart(
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    OnePlusGamma_pTheta const& one_gt, double const sqrtPhi,
    typename SolidGeosed<DisplacementDim>::KelvinVector const& dtheta_dsigma,
...
double yieldFunction(
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    typename SolidGeosed<DisplacementDim>::MaterialProperties const& mp,
...
void calculatePlasticResidual(
    ...
    typename SolidGeosed<DisplacementDim>::ResidualVectorType& residual)
{
    static int const KelvinVectorSize =
        ProcessLib::KelvinVectorDimensions<DisplacementDim>::value;
    using Invariants = MaterialLib::SolidModels::Invariants<KelvinVectorSize>;
...
void calculatePlasticJacobian(
    ...
    double const t,
    ProcessLib::SpatialPosition const& x,
    typename SolidGeosed<DisplacementDim>::JacobianMatrix& jacobian,
    PhysicalStressWithInvariants<DisplacementDim> const& s,
    double const lambda,
    typename SolidGeosed<DisplacementDim>::MaterialProperties const& _mp)
{
...
template <int DisplacementDim>
void SolidGeosed<DisplacementDim>::updateDamage(
    double const t, ProcessLib::SpatialPosition const& x,
...
template <int DisplacementDim>
void SolidGeosed<DisplacementDim>::MaterialProperties::
...
template <int DisplacementDim>
typename SolidGeosed<DisplacementDim>::KelvinVector predict_sigma(
    double const G, double const K,
    typename SolidGeosed<DisplacementDim>::KelvinVector const& sigma_prev,
    typename SolidGeosed<DisplacementDim>::KelvinVector const& eps,
    typename SolidGeosed<DisplacementDim>::KelvinVector const& eps_prev,
    double const eps_V)
{
    static int const KelvinVectorSize =
        ProcessLib::KelvinVectorDimensions<DisplacementDim>::value;
    ...
    typename SolidGeosed<DisplacementDim>::KelvinVector const sigma_D_prev =
        P_dev * sigma_prev / G;
    // dimensionless deviatoric stress
    typename SolidGeosed<DisplacementDim>::KelvinVector const sigma_D =
        sigma_D_prev + 2 * P_dev * (eps - eps_prev);
    return sigma_D - pressure * Invariants::identity2;
}

template <int DisplacementDim>
bool SolidGeosed<DisplacementDim>::computeConstitutiveRelation(
    double const t,
    ProcessLib::SpatialPosition const& x,
    double const dt,
