...
namespace MathLib
{
/// Gauss-Lobatto quadrature on pyramid
///
/// \tparam ORDER   integration order.
template <unsigned ORDER>
struct GaussLobattoPyramid
{
...
template <>
const std::array<std::array<double, 3>, GaussLobattoPyramid<1>::NPoints>
    GaussLobattoPyramid<1>::X;
template <>
double const GaussLobattoPyramid<1>::W[1];
#endif
}  // namespace MathLib
