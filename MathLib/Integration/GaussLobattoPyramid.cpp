...
#include "GaussLobattoPyramid.h"

namespace MathLib
{
template <>
const std::array<std::array<double, 3>, GaussLobattoPyramid<1>::NPoints>
    GaussLobattoPyramid<1>::X = {{{{1. / 3., 1. / 3., 1. / 3.}}}};
template <>
double const GaussLobattoPyramid<1>::W[1] = {1.0};

const std::array<std::array<double, 3>, GaussLobattoPyramid<2>::NPoints>
    GaussLobattoPyramid<2>::X = {
        {{{-0.584237394672177188, -0.584237394672177188, -2. / 3.}},
         {{0.584237394672177188, -0.584237394672177188, -2. / 3.}},
         {{0.584237394672177188, 0.584237394672177188, -2. / 3.}},
         {{-0.584237394672177188, 0.584237394672177188, -2. / 3.}},
         {{0., 0., 2. / 5.}}}};
double const GaussLobattoPyramid<2>::W[5] = {81. / 100., 81. / 100., 81. / 100.,
                                             81. / 100., 125. / 27.};

const std::array<std::array<double, 3>, GaussLobattoPyramid<3>::NPoints>
    GaussLobattoPyramid<3>::X = {
        {{{-0.673931986207731726, -0.673931986207731726,
         ...
         {{-0.580939660561084423, 0.580939660561084423,
           -0.830065359477124183}}}};
double const GaussLobattoPyramid<3>::W[13] = {
