...
#include "ProcessLib/SmallDeformationNonlocalHydroMechanics/CreateLocalAssemblers.h"

#include "SmallDeformationNonlocalHydroMechanicsFEM.h"
...
class SmallDeformationNonlocalHydroMechanicsProcess final : public Process
{
public:
...
extern template class ProcessLib::SmallDeformationNonlocalHydroMechanics::
    SmallDeformationNonlocalHydroMechanicsProcess<2>;
extern template class ProcessLib::SmallDeformationNonlocalHydroMechanics::
