...
#include "CreateSmallDeformationNonlocalHydroMechanicsProcess.h"
...
class SmallDeformationNonlocalHydroMechanicsProcess;

extern template class SmallDeformationNonlocalHydroMechanicsProcess<2>;
extern template class SmallDeformationNonlocalHydroMechanicsProcess<3>;
    ...
    BaseLib::ConfigTree const& config)
{
    ...
    NumLib::NamedFunctionCaller named_function_caller(
        {"SmallDeformationNonlocalHydroMechanics_displacement"});
