...
SmallDeformationNonlocalHydroMechanicsProcess<DisplacementDim>::
    SmallDeformationNonlocalHydroMechanicsProcess(
        MeshLib::Mesh& mesh,
...
template <int DisplacementDim>
void SmallDeformationNonlocalHydroMechanicsProcess<DisplacementDim>::
...
void SmallDeformationNonlocalHydroMechanicsProcess<
    DisplacementDim>::preAssembleConcreteProcess(const double t,
                                                 GlobalVector const& x)
{
    DBUG("preAssemble SmallDeformationNonlocalHydroMechanicsProcess.");
...
void SmallDeformationNonlocalHydroMechanicsProcess<DisplacementDim>::
    assembleWithJacobianConcreteProcess(const double t, GlobalVector const& x,
                                        ...
                                        GlobalMatrix& Jac)
{
    DBUG("AssembleWithJacobian SmallDeformationNonlocalHydroMechanicsProcess.");
...
{
    DBUG("PreTimestep SmallDeformationNonlocalHydroMechanicsProcess.");
...
void SmallDeformationNonlocalHydroMechanicsProcess<
    DisplacementDim>::postTimestepConcreteProcess(GlobalVector const& x,
                                                  int const /*process_id*/)
{
    DBUG("PostTimestep SmallDeformationNonlocalHydroMechanicsProcess.");
...
template class SmallDeformationNonlocalHydroMechanicsProcess<2>;
template class SmallDeformationNonlocalHydroMechanicsProcess<3>;
