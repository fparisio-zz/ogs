...
#include "MathLib/Integration/GaussLobattoTet.h"
#include "MathLib/TemplateWeightedPoint.h"

namespace NumLib
{
/**
 * \brief Gauss-Lobatto quadrature rule for tetrahedrals
 */
class IntegrationGaussLobattoTet
{
...
public:
     ...
     */
    explicit IntegrationGaussLobattoTet(unsigned order = 2)
    ...
    static WeightedPoint getWeightedPoint(unsigned order, unsigned igp)
    {
        ...
        {
            case 1:
                return getWeightedPoint<MathLib::GaussLobattoTet<1>>(igp);
            case 2:
                return getWeightedPoint<MathLib::GaussLobattoTet<2>>(igp);
            case 3:
                return getWeightedPoint<MathLib::GaussLobattoTet<3>>(igp);
        }
    ...
    static unsigned getNumberOfPoints(unsigned order)
    {
        ...
        {
            case 1:
                return MathLib::GaussLobattoTet<1>::NPoints;
            case 2:
                return MathLib::GaussLobattoTet<2>::NPoints;
            case 3:
                return MathLib::GaussLobattoTet<3>::NPoints;
        }
        return 0;
    }
