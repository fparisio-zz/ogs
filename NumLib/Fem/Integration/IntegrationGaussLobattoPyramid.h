...
#include "MathLib/Integration/GaussLobattoPyramid.h"
#include "MathLib/TemplateWeightedPoint.h"

namespace NumLib
{
/**
 * \brief Gauss-Lobatto quadrature rule for pyramid
 */
class IntegrationGaussLobattoPyramid
{
...
public:
     ...
     */
    explicit IntegrationGaussLobattoPyramid(unsigned order = 2)
    ...
    static WeightedPoint getWeightedPoint(unsigned order, unsigned igp)
    {
        ...
        {
            case 1:
                return getWeightedPoint<MathLib::GaussLobattoPyramid<1>>(igp);
            case 2:
                return getWeightedPoint<MathLib::GaussLobattoPyramid<2>>(igp);
            case 3:
                return getWeightedPoint<MathLib::GaussLobattoPyramid<3>>(igp);
        }
    ...
    static unsigned getNumberOfPoints(unsigned order)
    {
        ...
        {
            case 1:
                return MathLib::GaussLobattoPyramid<1>::NPoints;
            case 2:
                return MathLib::GaussLobattoPyramid<2>::NPoints;
            case 3:
                return MathLib::GaussLobattoPyramid<3>::NPoints;
        }
        return 0;
    }
