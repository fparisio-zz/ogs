...
{
/**
 * \brief Gauss-Lobatto quadrature rule for triangles
 *
 * Gauss-Lobatto quadrature rule for triangles is originally given as
 * \f[
 ...
 */
class IntegrationGaussLobattoTri
{
...
public:
     ...
     */
    explicit IntegrationGaussLobattoTri(unsigned order = 2)
    ...
    static WeightedPoint getWeightedPoint(unsigned order, unsigned igp)
    {
        ...
        {
            case 1:
                return getWeightedPoint<MathLib::GaussLobattoTri<1>>(igp);
            case 2:
                return getWeightedPoint<MathLib::GaussLobattoTri<2>>(igp);
            case 3:
                return getWeightedPoint<MathLib::GaussLobattoTri<3>>(igp);
        }
    ...
    static unsigned getNumberOfPoints(unsigned order)
    {
        ...
        {
            case 1:
                return MathLib::GaussLobattoTri<1>::NPoints;
            case 2:
                return MathLib::GaussLobattoTri<2>::NPoints;
            case 3:
                return MathLib::GaussLobattoTri<3>::NPoints;
        }
        return 0;
    }
